...
const slackChannel = process.env.slackChannel; // 投稿するSlackのチャンネルを指定
const googleApiKey = process.env.googleApiKey;
const newsdataiokey = process.env.newsdataiokey;
...
async function translateText(str, sourceLang, targetLang) {
  const url = `https://translation.googleapis.com/language/translate/v2?key=${googleApiKey}&q=${encodeURIComponent(
    str
